package io.github.chains_project.tracediff.scanner.githubapi.code_changes.models;
...
public class SelectedPullRequest {
    ...
    public SelectedPullRequest(GHPullRequest pr) {
        this.id = pr.getId();
        this.number = pr.getNumber();
        this.url = pr.getUrl().toString();
        this.headCommitSHA1 = pr.getHead().getSha();
        this.repoName = pr.getRepository().getFullName();
    }
